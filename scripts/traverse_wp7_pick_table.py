...
def main() -> None:
    ...
    ap.add_argument("--cheap", nargs="*", default=[], help="NAME=predictions.json (traverse_wp7_cheap_predictor.py)")
    ap.add_argument("--imagine", nargs="*", default=[], help="NAME=rows.json (traverse_wp7_imagine_cache.py)")
