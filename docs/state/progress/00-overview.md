...
| **Study 4 — quadruped on CRM** | **Collecting.** Rigid half done (968 episodes, 1.43 M transitions, zero falls); CRM half running on both boxes (~304 episodes, 0.45 M) | Repair, gate, preprocess, then train — see [`quadruped-status.md`](quadruped-status.md) |
